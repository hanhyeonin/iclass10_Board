...
<body class="is-preload">
	<div id="page-wrapper">
		...
		<div id="header">
			...
			<!-- Logo -->
			<h1>
				<a href="index.html" id="logo">우리동네 <em>북카페</em></a>
			</h1>
		...
		<!-- Banner -->
		<section id="banner">
			<img alt="" src="images/bookmain.png" width="100%" height="100%"
				...
				<div class="row gtr-200">
					...
					<section class="col-4 col-12-narrower">
						<div class="box highlight">
							...
							<h3>우리동네 책벌레</h3>
							<p>
								매달 좋은 책들을 소개하고<br> 책 이야기 많이 해주시는 책벌레들을 <br>소개합니다.
							</p>
						</div>
					</section>
					<section class="col-4 col-12-narrower">
